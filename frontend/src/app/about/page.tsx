    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col font-sans overflow-x-hidden">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 md:py-24 space-y-12 flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center pt-8 border-t border-neutral-900">
          ...
          <div className="h-64 w-full bg-neutral-900 rounded-3xl border border-neutral-900 overflow-hidden shadow-2xl">
            <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center pt-8 border-t border-neutral-900">
          <div className="h-64 w-full bg-neutral-900 rounded-3xl border border-neutral-900 overflow-hidden shadow-2xl order-last md:order-first">
            <img
