    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col font-sans">
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 py-20 text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-2">
          <Link
            href="/"
            className="px-6 py-3 rounded-2xl bg-neutral-900 border border-neutral-800 text-neutral-300 hover:text-white font-bold text-xs uppercase tracking-wider transition-all"
          >
            Go to Homepage
          </Link>
          <Link
            href="/menu"
            className="px-6 py-3 rounded-2xl bg-red-600 hover:bg-red-700 text-white font-bold text-xs uppercase tracking-wider flex items-center gap-1.5 shadow-lg shadow-red-950/20 transition-all"
          >
