...
export default function Testimonials() {
  ...
  return (
    <section id="reviews" className="w-full py-16 md:py-24 bg-neutral-950/40 select-none">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {/* Sliding Card Frame */}
        <div className="relative min-h-[260px] bg-neutral-900/30 border border-neutral-900 rounded-3xl p-6 sm:p-10 flex flex-col justify-between items-center text-center shadow-xl">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Content Description */}
              <p className="text-sm sm:text-base text-neutral-300 font-medium italic leading-relaxed max-w-2xl mx-auto">
              ...
              <div className="flex flex-col items-center justify-center space-y-2">
                <div
                  className={`h-11 w-11 rounded-full bg-gradient-to-tr ${current.avatarColor} flex items-center justify-center text-white text-xs font-black uppercase shadow-lg shadow-neutral-950`}
                >
                  {current.name.substring(0, 2)}
                </div>
                <div>
                  <h4 className="text-sm font-bold text-neutral-100">{current.name}</h4>
