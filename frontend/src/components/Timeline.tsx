...
export default function Timeline() {
  return (
    <section id="how-it-works" className="w-full py-16 md:py-24 bg-neutral-950/20 select-none">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-4 mt-8">
          ...
          <div className="hidden md:block absolute top-12 left-[12%] right-[12%] h-0.5 bg-neutral-900 z-0">
            <motion.div
              initial={{ width: 0 }}
          ...
          {STEPS.map((step, idx) => {
            ...
            return (
              ...
              >
                {/* Step Circle Badge */}
                <div
                  className={`h-16 w-16 rounded-2xl bg-gradient-to-tr ${step.color} p-4 flex items-center justify-center text-white shadow-xl shadow-neutral-950`}
                >
                ...
                <div className="space-y-1.5 px-4">
                  <span className="text-[10px] font-black text-neutral-500 font-mono tracking-widest uppercase">
                    STEP 0{step.id}
                  </span>
                  <h4 className="text-base font-extrabold text-neutral-200">{step.title}</h4>
