    ...
    <>
      <nav
        className={`sticky top-0 z-40 w-full transition-all duration-300 ${
          isScrolled
            ? 'bg-neutral-950/80 backdrop-blur-xl border-b border-neutral-900 shadow-[0_4px_30px_rgba(239,68,68,0.03)]'
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              {[
                ...
                <button
                  key={link.name}
                  onClick={link.action}
                  className="text-sm font-semibold text-neutral-400 hover:text-white hover:scale-105 transition-all duration-200 cursor-pointer"
                >
                  {link.name}
                </button>
              ))}
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="p-2 rounded-full bg-neutral-900/60 border border-neutral-800/40 text-neutral-400 hover:text-white hover:border-neutral-700 hover:bg-neutral-800 transition-all duration-200 cursor-pointer"
              ...
              <button
                ...
                className="relative p-2 rounded-full bg-neutral-900/60 border border-neutral-800/40 text-neutral-400 hover:text-white hover:border-neutral-700 hover:bg-neutral-800 transition-all duration-200 cursor-pointer"
              ...
              >
                ...
                {totalItems > 0 && (
                  <motion.span
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-600 text-[10px] font-extrabold text-white shadow-lg shadow-red-950/30"
                  >
                    {totalItems}
                  </motion.span>
                )}
              ...
              {isAuthenticated ? (
                ...
                <Link href="/login">
                  <button className="px-5 py-2 rounded-full bg-red-600 hover:bg-red-700 text-white font-bold text-sm tracking-wide shadow-lg shadow-red-950/20 hover:shadow-red-700/20 transition-all duration-250 cursor-pointer select-none">
                    Log In
                  </button>
                </Link>
              )}
        ...
        {isCartOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 z-50 w-full max-w-md bg-neutral-950 border-l border-neutral-900 shadow-2xl flex flex-col"
            >
              {/* Header */}
              <div className="p-6 border-b border-neutral-900 flex justify-between items-center">
                <div className="flex items-center gap-2">
                  <ShoppingCart className="h-5 w-5 text-red-500" />
                  <h3 className="text-lg font-bold text-neutral-100">Your Basket</h3>
                </div>
                <button
                  onClick={() => setIsCartOpen(false)}
                  className="p-2 rounded-xl bg-neutral-900/60 border border-neutral-800/40 text-neutral-400 hover:text-white hover:border-neutral-700 transition-colors cursor-pointer"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                {orderSuccess ? (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-neutral-100">Order Confirmed!</h4>
                    ...
                    <button
                      onClick={() => setIsCartOpen(false)}
                      className="px-6 py-2.5 rounded-full bg-neutral-950 border border-neutral-800 text-neutral-300 font-bold text-xs hover:text-white transition-all cursor-pointer"
                    >
                      Browse More Food
                    </button>
                  </motion.div>
                  ...
                  <div className="flex flex-col items-center justify-center text-center py-20 space-y-3">
                    ...
                    <p className="text-sm font-bold text-neutral-400">Your basket is empty</p>
                  ...
                  <div className="space-y-4">
                    ...
                    {subtotal < 499 ? (
                      ...
                      <div className="p-3.5 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 text-xs font-semibold text-emerald-400 flex items-center gap-1.5 justify-center">
                    ...
                    <div className="space-y-3">
                      {items.map((item, idx) => (
                        <div
                          ...
                          className="p-3 rounded-2xl bg-neutral-900/30 border border-neutral-900 flex gap-3"
                        >
                          ...
                          <div className="flex-1 min-w-0 flex flex-col justify-between">
                            ...
                            <div className="flex items-center justify-between mt-1">
                              ...
                              <div className="flex items-center gap-2 px-2.5 py-1 rounded-lg bg-neutral-950 border border-neutral-900">
                                <button
                                  onClick={() =>
                                    updateQuantity(
                                      item.product.id,
                ...
                <div className="p-6 border-t border-neutral-900 bg-neutral-950 space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full text-xs font-semibold px-3 py-2.5 rounded-xl bg-neutral-900 border border-neutral-800 text-neutral-200 placeholder-neutral-600 focus:border-red-500/50 outline-none transition-colors"
                    />
                  </div>

                  {/* Summary Calculations */}
                  <div className="space-y-1.5 text-xs text-neutral-400 font-semibold pt-1">
                    <div className="flex justify-between">
                      <span>Subtotal</span>
                      <span>₹{subtotal}</span>
                    </div>
                    ...
                    <div className="flex justify-between text-sm font-bold text-neutral-200 pt-1 border-t border-neutral-900">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-2xl bg-red-600 hover:bg-red-700 text-white font-bold text-sm tracking-wide shadow-lg shadow-red-950/20 hover:shadow-red-700/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
                  >
                    {isCheckingOut ? (
                      <>
